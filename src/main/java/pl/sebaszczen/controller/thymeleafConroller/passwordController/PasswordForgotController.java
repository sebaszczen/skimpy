package pl.sebaszczen.controller.thymeleafConroller.passwordController;
...
import pl.sebaszczen.domain.password.PasswordForgotDto;
import pl.sebaszczen.domain.password.PasswordResetToken;
...
public class PasswordForgotController {
    ...
    public String processForgotPasswordForm(@ModelAttribute("forgotPasswordForm") @Valid PasswordForgotDto form,
        ...
        model.put("templateHtml", "email-template");
        mail.setModel(model);
